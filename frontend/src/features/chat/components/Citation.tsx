...
export function Citation({
  ...
  return (
    ...
    >
      ...
      <span
        role="tooltip"
        className="invisible absolute bottom-full left-1/2 z-50 mb-2 w-72 max-w-[calc(100vw-1.5rem)] -translate-x-1/2 rounded-sm border border-foreground/25 bg-surface px-3 py-2.5 opacity-0 shadow-[0_8px_24px_-8px_rgba(0,0,0,0.55)] transition-[opacity,visibility] duration-150 ease-out group-hover:visible group-hover:opacity-100"
      >
